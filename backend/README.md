...
## Project Structure
    ...
    ├── example_project_dev_23734  # Django project configurations
...
1. Clone this repo and `cd example_project_dev_23734`
...
2. Clone this repo and `cd example_project_dev_23734`
